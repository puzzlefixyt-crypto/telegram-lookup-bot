...
BOT_TOKEN = os.getenv("BOT_TOKEN") or "8127993303:AAFD-it_gOMdZJmIMupYMMuHxjzyJ-P522g"
if not BOT_TOKEN:
...
MOBILE_API = "https://api.paanel.shop/numapi.php?action=api&key=fdffimpv&number="
AADHAAR_API = "https://api.paanel.shop/numapi.php?action=api&key=fdffimpv&aadhar="
...
VNUM_API = "https://api.paanel.shop/numapi.php?action=api&key=asjsids&test1="
IP_API = "https://abbas-apis.vercel.app/api/ip?ip="
FF_API = "https://abbas-apis.vercel.app/api/ff-info?uid="
MOBILE_API_2 = "https://api.b77bf911.workers.dev/mobile?number="
BOMB_API = "https://Usesir.vercel.app/api/bambu?key=RADHA@2024z&num="
...
"""
                ...
                # ⚠️ SPECIAL CASE (response_code 601 / string data)
                if data and isinstance(data[0], str):
                    no_record_list.append(reg)
                    final_content += f"""
VEHICLE NUMBER : {reg}
----------------------------
⚠️ Record requires Parivahan API (restricted)
